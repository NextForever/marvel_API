    ...
    return (
        <div className='char__info'>
            <div className='char__basics'>
                ...
                <div>
                    ...
                    <div className='char__btns'>
                        <a href='test' className='button button__main'>
                            <div className='inner'>homepage</div>
                        </a>
                        <a href='test' className='button button__secondary'>
            ...
            <ul className='char__comics-list'>
                <li className='char__comics-item'>All-Winners Squad: Band of Heroes (2011) test3</li>
